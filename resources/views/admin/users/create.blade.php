        ...
        @endif
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="email" value="{{old('email',$users->email)}}"
                ...
                <div class="w-full">
                    ...
                    <input type="text" value="{{old('nickname',$users->nickname)}}"
                ...
                <div class="w-full">
                    ...
                    <input type="text" value="{{old('contra',$users->password)}}"
                     name="contra" id="contra" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  >
                    @error('contra')
                    <span class=" text-sm text-red-600" role="alert">
                        <strong>{{$message}}</strong>
                    @enderror

...
<div class="py-120">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <a href="{{route('admin.measures.index')}}" class="inline-flex items-center px-4 py-2 
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            ...
            <div class="w-full  md:max-w-full mx-auto">
                <div class="p-6 border border-gray-300 sm:rounded-md">
                  <form method="POST" 
                  @if ($measures->id)
                  action="{{route('admin.measures.update', ['measure'=>$measures->id])}}"
                  @else
                 ...
                 @endif
                    ...
                    <label class="block mb-6">
                      ...
                      <input
                        ...
                        "
                        value="{{old('nombre', $measures->nombre)}}"

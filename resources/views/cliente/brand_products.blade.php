                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                  ...
                  <li aria-current="page">
                    <div class="flex items-center">
                      ...
                      <span class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">{{ $brand->nombre }}</span>
                    </div>
                  </li>
                </ol>
              </nav>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-0 shadow-sm dark:border-gray-700 dark:bg-gray-800 hover:border-blue-500 transition-colors duration-300">
                <div class="h-48 w-full overflow-hidden ">
                  <a href="{{ route('view.product', ['id' => $p->id]) }}">
                    <img class="w-full h-full object-contain rounded-t-lg" src="{{ asset($p->image_url) }}" alt="" />
                ...
                <div class="pt-6 p-6">
                  ...
                  <div class="flex justify-center items-center ">
                    <a href="{{ route('view.product', ['id' => $p->id]) }}" class="text-xl  font-bold leading-tight text-gray-900  dark:text-white">
                        {{ $p->nombre }}
                    </a>
                </div>

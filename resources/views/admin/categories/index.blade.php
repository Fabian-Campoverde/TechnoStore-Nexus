...
@section('container')
    ...
    focus:ring-offset-2 transition ease-in-out duration-150 ml-4">
        ...
        <div class="bg-{{session('color')}}-100 border-t border-b border-green-500 text-{{session('color')}}-700 px-4 py-3" role="alert">
            ...
            <div id="alert" class="bg-{{session('color')}}-100 border-t border-b border-{{session('color')}}-500 text-{{session('color')}}-700 px-4 py-3 relative" role="alert">
                <p class="font-bold">{{ session('message') }}</p>
                <p class="text-sm">Some additional text to explain the message.</p>
                <button id="closeAlert" class="absolute top-0 right-0 mt-2 mr-2  focus:outline-none">
                    <span>&times;</span>
                </button>
            </div>
